...
namespace Hos.ScheduleMaster.xUnitTest.Utils
{
    public class LockTest
    {
        ...
        public void DatabaseLock()
        {
            ...
            //EF数据库上下文
            services.AddDbContext<SmDbContext>(option => option.UseMySql(ServerVersion.AutoDetect("Data Source=192.168.8.27;Database=schedule_master;User ID=root;Password=123456;pooling=true;CharSet=utf8;port=3306;sslmode=none;TreatTinyAsBoolean=true")), ServiceLifetime.Transient);
